"""
Django settings for krystal_quickpick_45901 project.
...
ROOT_URLCONF = 'krystal_quickpick_45901.urls'
...
WSGI_APPLICATION = 'krystal_quickpick_45901.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "krystal_quickpick_45901 API",
    "DESCRIPTION": "API documentation for krystal_quickpick_45901 App",
    "VERSION": "v1",
}
